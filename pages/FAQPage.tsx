      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <section>
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-stone-800 mb-8 tracking-tight">
          ...
          <div className="space-y-4">
            {FAQS.map((faq, index) => (
              <motion.div
                ...
                className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden dash-card"
              >
                <button
                ...
                <AnimatePresence initial={false}>
                  {activeFaq === index && (
                    ...
                    >
                      <div className="px-5 pb-5 text-stone-500 text-sm leading-relaxed border-t border-stone-200 pt-4 mx-5">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
