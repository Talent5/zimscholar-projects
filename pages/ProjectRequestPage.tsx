...
const ProjectRequestPage: React.FC = () => {
  const benefits = [
    ...
    {
      icon: <Wrench size={24} className="text-neon-purple" />,
    ...
    <div className="fade-in py-12">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {benefits.map((benefit, i) => (
            <motion.div
              ...
              className="glass rounded-2xl p-6 border border-glass-border text-center glow-card"
            >
              <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-glass-light flex items-center justify-center">
                {benefit.icon}
              </div>
        ...
        <motion.div
          ...
          className="mt-12 glass rounded-2xl p-6 border border-neon-cyan/10"
        >
          <h3 className="font-bold text-white text-lg mb-3">What Happens Next?</h3>
          <ol className="space-y-3 text-slate-400 text-sm">
            {[
              ...
              <li key={i} className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-neon-cyan/10 border border-neon-cyan/20 flex items-center justify-center text-neon-cyan text-xs font-bold">
                  {i + 1}
                </span>
