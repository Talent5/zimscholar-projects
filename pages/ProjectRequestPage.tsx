      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {benefits.map((benefit, i) => (
            ...
            >
              <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-sky-50 flex items-center justify-center">
                {benefit.icon}
              </div>
        ...
        <motion.div
          ...
          className="mt-12 bg-white rounded-2xl p-6 border border-slate-100 shadow-sm"
        >
          <h3 className="font-bold text-slate-900 text-lg mb-3">What Happens Next?</h3>
          <ol className="space-y-3 text-slate-500 text-sm">
            {[
              ...
              <li key={i} className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-sky-50 border border-sky-200 flex items-center justify-center text-neon-cyan text-xs font-bold">
                  {i + 1}
                </span>
