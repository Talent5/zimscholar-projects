...
export const Footer: React.FC = () => {
  ...
  return (
    <footer ref={ref} className="relative bg-[#faf7f3] border-t border-stone-200 overflow-hidden section-divider">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-bold text-stone-800">ScholarXafrica</h3>
            </div>
          ...
          <motion.div
            ...
            custom={1}
          >
            <h4 className="text-sm font-bold text-stone-800 uppercase tracking-wider mb-6 flex items-center gap-2">
            ...
            <ul className="space-y-3">
              {links.map((link) => (
                <li key={link.to}>
                  <Link
                    to={link.to}
                    className="text-stone-500 hover:text-neon-cyan transition-colors text-sm flex items-center gap-1 group"
                  >
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white border border-stone-200 text-green-500 hover:bg-stone-50 transition-all text-sm font-medium"
                >
        ...
        >
          ...
          <p className="mt-3 text-stone-400 text-[11px] max-w-xl mx-auto leading-relaxed">
